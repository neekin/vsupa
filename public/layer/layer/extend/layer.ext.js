...
layer.photos = function(options){
    ...
    if(json){
        ...
        log.thissrc = (nowimg.attr('data-src') || nowimg.attr('data-src'));
        log.pid = nowimg.attr('data-pid');
    ...
    log.event = function(){
        ...
        log.tabimg = function(){
            ...
            if(json){
                ...
                src = thisimg.attr('data-src') || thisimg.attr('data-src');
                pid = thisimg.attr('data-pid') || '';
