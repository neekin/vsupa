module ApplicationHelper
  ...
  def time_ago_in_words_cn(from_time,include_seconds = false)
     distance_of_time_in_words_cn(from_time, Time.now, include_seconds)
  end

  def distance_of_time_in_words_cn(from_time, to_time = 0, include_seconds = false)
